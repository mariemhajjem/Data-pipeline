...
class KafkaIngestion:
    ...
    def kafka_ingest(self):
        ...
        #
        #     df.writeStream.outputMode("complete").foreachBatch(save).start()
        ...
        # console = diffInSeconds.writeStream.outputMode("append").format("console").start()
